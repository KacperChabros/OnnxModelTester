...
{
    public class FullVisionNavigatorColorMap : IPaddleSegColorMap
    {
        private readonly Dictionary<byte, byte[]> _colorMap = new Dictionary<byte, byte[]>
            {
                ...
                { 9,    new byte[] { 37,        219,    188,    192 } },         // bike_path, cyan?
                { 10,   new byte[] { 255,       253,    208,    192 } },         // zebra, beige
                { 11,   new byte[] { 143,       143,    144,    192 } },         // animal, grey
                { 12,   new byte[] { 204,       51,     102,    192 } },         // train, claret
            };
