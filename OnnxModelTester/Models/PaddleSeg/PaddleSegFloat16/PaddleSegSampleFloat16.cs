...
{
    public class PaddleSegSampleFloat16 : VisionSampleBase<PaddleSegImageProcessorFloat16>
    {
        ...
        public PaddleSegSampleFloat16(string modelFilename, IPaddleSegColorMap colorMap, List<long> predictions)
        ...
        List<PaddleSegPrediction> GetPredictions(Tensor<Float16> input, int sourceImageWidth, int sourceImageHeight)
        {
