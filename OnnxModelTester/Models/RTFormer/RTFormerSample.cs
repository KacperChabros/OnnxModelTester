...
{
    public class RTFormerSample : VisionSampleBase<RTFormerImageProcessor>
    {
        public const string Identifier = "RTFormer";
        public const string ModelFilename = "model_rtformer1.onnx";

        public RTFormerSample()
        ...
        List<RTFormerPrediction> GetPredictions(Tensor<float> input, int sourceImageWidth, int sourceImageHeight)
        {
